...
typedef enum {
    ...
    /**< window covering */
    ESPNOW_ATTRIBUTE_WINDOW_COVERING_BASE     = 0x0400,
    ESPNOW_ATTRIBUTE_WINDOW_COVERING_UP       = 0x0401,
    ESPNOW_ATTRIBUTE_WINDOW_COVERING_DOWN     = 0x0402,
    ESPNOW_ATTRIBUTE_WINDOW_COVERING_STOP     = 0x0403,
    ESPNOW_ATTRIBUTE_WINDOW_COVERING_POSITION = 0x0404,
} espnow_attribute_t;
